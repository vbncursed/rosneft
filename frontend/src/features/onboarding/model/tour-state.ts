...
// Pure tour state + transitions: a state interface, an IDLE constant, and total
// functions between them. Nothing here touches the DOM — the caller decides
// whether a step's target exists and calls next() when it doesn't.
