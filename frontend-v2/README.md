...
| `entities` | conversion, content, territory, model, audit, user, role, metric, placement, permission, scene, measurement |
| `features` | measure, onboarding, recovery-codes, theme-toggle, audit-filter, role-assign, create-user, create-role, grant-access, login, viewer-mode, lod, placements-editor |
