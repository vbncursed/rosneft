...
| `github.com/pquerna/otp` | v1.5.0 | TOTP secret generation + code verification |
...
| `github.com/redis/go-redis/v9` | v9.21.0 | 2FA attempt rate-limit / lockout state (logical DB 2) |
