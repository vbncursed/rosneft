...
import { dirToYaw } from "@/entities/panorama";
...
// CameraTracker mirrors the live camera position and horizontal yaw into
// imperative refs so components outside the Canvas (the panorama edit panel)
// can read them on demand. Lives inside the Canvas tree for useThree.
export default function CameraTracker({ positionRef, yawRef }: CameraTrackerProps) {
