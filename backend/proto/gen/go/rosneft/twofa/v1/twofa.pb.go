...
type StatusResponse struct {
	...
	EnabledAt         int64 `protobuf:"varint,2,opt,name=enabled_at,json=enabledAt,proto3" json:"enabled_at,omitempty"`
	RecoveryRemaining int64 `protobuf:"varint,3,opt,name=recovery_remaining,json=recoveryRemaining,proto3" json:"recovery_remaining,omitempty"`
	RecoveryTotal     int64 `protobuf:"varint,4,opt,name=recovery_total,json=recoveryTotal,proto3" json:"recovery_total,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *StatusResponse) GetEnabledAt() int64 {
	if x != nil {
		return x.EnabledAt
	}
	return 0
...
func (x *StatusResponse) GetRecoveryRemaining() int64 {
	if x != nil {
		return x.RecoveryRemaining
	}
	return 0
}

func (x *StatusResponse) GetRecoveryTotal() int64 {
	if x != nil {
...
func (x *VerifyRequest) Reset() {
	*x = VerifyRequest{}
	mi := &file_rosneft_twofa_v1_twofa_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VerifyRequest) Descriptor() ([]byte, []int) {
	return file_rosneft_twofa_v1_twofa_proto_rawDescGZIP(), []int{14}
}
...
func (x *VerifyResponse) Reset() {
	*x = VerifyResponse{}
	mi := &file_rosneft_twofa_v1_twofa_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VerifyResponse) Descriptor() ([]byte, []int) {
	return file_rosneft_twofa_v1_twofa_proto_rawDescGZIP(), []int{15}
}
...
const file_rosneft_twofa_v1_twofa_proto_rawDesc = "" +
	...
	"\n" +
	"enabled_at\x18\x02 \x01(\x03R\tenabledAt\x12-\n" +
	"\x12recovery_remaining\x18\x03 \x01(\x03R\x11recoveryRemaining\x12%\n" +
	"\x0erecovery_total\x18\x04 \x01(\x03R\rrecoveryTotal\"+\n" +
	...
	"\x05valid\x18\x01 \x01(\bR\x05valid2\xa4\x05\n" +
	"\fTwoFAService\x12H\n" +
	...
	"\x17RegenerateRecoveryCodes\x12#.rosneft.twofa.v1.RegenerateRequest\x1a$.rosneft.twofa.v1.RegenerateResponse\x12K\n" +
	"\x06Status\x12\x1f.rosneft.twofa.v1.StatusRequest\x1a .rosneft.twofa.v1.StatusResponse\x12T\n" +
...
var file_rosneft_twofa_v1_twofa_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_rosneft_twofa_v1_twofa_proto_goTypes = []any{
	...
	(*StatusRequest)(nil),      // 8: rosneft.twofa.v1.StatusRequest
	(*StatusResponse)(nil),     // 9: rosneft.twofa.v1.StatusResponse
	(*IsEnabledRequest)(nil),   // 10: rosneft.twofa.v1.IsEnabledRequest
	(*IsEnabledResponse)(nil),  // 11: rosneft.twofa.v1.IsEnabledResponse
	(*EnabledForRequest)(nil),  // 12: rosneft.twofa.v1.EnabledForRequest
	(*EnabledForResponse)(nil), // 13: rosneft.twofa.v1.EnabledForResponse
	(*VerifyRequest)(nil),      // 14: rosneft.twofa.v1.VerifyRequest
	(*VerifyResponse)(nil),     // 15: rosneft.twofa.v1.VerifyResponse
}
var file_rosneft_twofa_v1_twofa_proto_depIdxs = []int32{
	...
	8,  // 4: rosneft.twofa.v1.TwoFAService.Status:input_type -> rosneft.twofa.v1.StatusRequest
	10, // 5: rosneft.twofa.v1.TwoFAService.IsEnabled:input_type -> rosneft.twofa.v1.IsEnabledRequest
	12, // 6: rosneft.twofa.v1.TwoFAService.EnabledFor:input_type -> rosneft.twofa.v1.EnabledForRequest
	14, // 7: rosneft.twofa.v1.TwoFAService.Verify:input_type -> rosneft.twofa.v1.VerifyRequest
	1,  // 8: rosneft.twofa.v1.TwoFAService.Setup:output_type -> rosneft.twofa.v1.SetupResponse
	3,  // 9: rosneft.twofa.v1.TwoFAService.Enable:output_type -> rosneft.twofa.v1.EnableResponse
	5,  // 10: rosneft.twofa.v1.TwoFAService.Disable:output_type -> rosneft.twofa.v1.DisableResponse
	7,  // 11: rosneft.twofa.v1.TwoFAService.RegenerateRecoveryCodes:output_type -> rosneft.twofa.v1.RegenerateResponse
	9,  // 12: rosneft.twofa.v1.TwoFAService.Status:output_type -> rosneft.twofa.v1.StatusResponse
	11, // 13: rosneft.twofa.v1.TwoFAService.IsEnabled:output_type -> rosneft.twofa.v1.IsEnabledResponse
	13, // 14: rosneft.twofa.v1.TwoFAService.EnabledFor:output_type -> rosneft.twofa.v1.EnabledForResponse
	15, // 15: rosneft.twofa.v1.TwoFAService.Verify:output_type -> rosneft.twofa.v1.VerifyResponse
