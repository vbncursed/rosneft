...
func openDB(dsn string) (*sql.DB, error) {
	...
	// twofa shares the `andrey` database with catalog + auth; a custom version
	// table keeps the services' migration histories from colliding.
	goose.SetTableName("twofa_goose_db_version")
