...
func (x *UpdatePanoramaRequest) GetTerritorySlug() string {
	if x != nil {
		return x.TerritorySlug
	}
	return ""
...
func (x *DeletePanoramaRequest) GetTerritorySlug() string {
	if x != nil {
		return x.TerritorySlug
	}
	return ""
...
func (x *DeleteDocumentRequest) GetTerritorySlug() string {
	if x != nil {
		return x.TerritorySlug
	}
	return ""
...
const file_rosneft_content_v1_content_proto_rawDesc = "" +
	...
	"defaultYaw\x12%\n" +
	"\x0eterritory_slug\x18\x06 \x01(\tR\rterritorySlug\"R\n" +
	"\x16UpdatePanoramaResponse\x128\n" +
	"\bpanorama\x18\x01 \x01(\v2\x1c.rosneft.content.v1.PanoramaR\bpanorama\"N\n" +
	...
	"\bdocument\x18\x01 \x01(\v2\x1c.rosneft.content.v1.DocumentR\bdocument\"N\n" +
